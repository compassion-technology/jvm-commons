...
public class JaroWinklerDistance {
	private static final double WEIGHT_DENOM = 3.0;
	private static final double POS_COEFF = 0.1;
	 ...
	 * sequences. The distance is symmetric and will fall in the range
