 ...
 * 
 * @deprecated this copy is provided for transitive ERI dependencies (like eri-commons-jdbc) that still expect
 * these utilities at this package. Any changes should be made to {@link com.compassion.commons.LambdaUtils}.
