...
public class SWTGraphics2D extends Graphics2D {
	...
	public SWTGraphics2D(GC gc) {
		...
		this.fontMetrics = new FontMetrics(SWTUtils.DUMMY_PANEL.getFont()) {
			@Override
			public int charsWidth(char[] data, int off, int len) {
				return gc.textExtent(new String(data, off, len)).x;
			}

			@Override
			public int charWidth(char ch) { return gc.getAdvanceWidth(ch); }
			@Override
			public int getAscent() { return swtfm.getAscent(); }
			@Override
			public int getDescent() { return swtfm.getDescent(); }
			@Override
			public int getHeight() { return swtfm.getHeight(); }
			@Override
			public int getLeading() { return swtfm.getLeading(); }
		};
	}
	...
	public Stroke getStroke() {
        return new BasicStroke(this.gc.getLineWidth(), this.gc.getLineCap() - 1, this.gc.getLineJoin() - 1);
    }
     ...
     */
    private static AffineTransform toAwtTransform(Transform swtTransform) {
